...
Input SCV2 Login OTP
    ...
    FOR  ${index}  IN RANGE    1    ${count+1}
        ${locator}=    Set Variable    ${OTPField.format(${index})}
        Input Text    ${locator}    ${OTPCharactersSplit}[${index-1}]
    END
...
Input Address Form
    ...
    IF    ${AddressLabelIsVisible}
        ...
        END
    END
    Clear SCV Add New Address Phone Number Text Field    ${InputAddressPhoneNumber}
